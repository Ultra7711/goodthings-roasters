...
export const CAFE_MENU: CafeMenuItem[] = [
  ...
  // BREWING / COFFEE
  { id: 'b01', name: '블렌딩', cat: 'brewing', status: '', temp: 'both', badge2: '', price: 5000, desc: '', img: '/images/cafe-menu/cm_img_americano.webp', bg: '#ede8e0', menuDesc: '', vol: '350ml', kcal: 10, satfat: '0.0g', sugar: '0.5g', sodium: '8mg', protein: '0.3g', caffeine: '185mg', allergen: '고카페인 함유' },
