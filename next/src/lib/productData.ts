/* ══════════════════════════════════════════
   ...
   Phase 3 (Supabase) 전환 시 DB 데이터로 교체
   ══════════════════════════════════════════ */

import type { Product, DripBagRecipe } from '@/types/product';
...
export const PRODUCTS: Product[] = [
  {
    ...
    subscription: true,
    images: [
      { bg: '#ECEAE6', bgTheme: 'light', src: '/images/products/pd_img_autumn_night.webp' },
    ],
  ...
  },
  {
    ...
    subscription: true,
    images: [
      { bg: '#ECEAE6', bgTheme: 'light', src: '/images/products/pd_img_refreshing_afternoon.webp' },
    ],
