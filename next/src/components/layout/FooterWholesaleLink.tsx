/* ══════════════════════════════════════════
   ...
   - /wholesale 내에서 클릭 시 preventDefault + 'gtr:biz-reset' 이벤트 발송
   - 다른 라우트에서는 일반 Link 동작 (/wholesale 네비게이션)
...
export default function FooterWholesaleLink() {
  ...
  return (
    <Link href="/wholesale" className="footer-col-link" onClick={handleClick}>
      Wholesale
    </Link>
  );
}
