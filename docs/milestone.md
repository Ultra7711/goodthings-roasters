...
| PR-7 | 헤딩 line-height 정합 회귀 fix — PR-2 ratio→정수 일괄 변환 시 font-size 무관 `1.3 → 20px` 박힘. `#pd-name` (h1 · 🔴) + `.blk-heading`·`.tci-h` (h3 · 🟡) + `--lh-h3` 토큰 정의 + 추가 audit (1.4→20 · 1.2→16 박힌 헤딩 전수 확인) | ⬜ S145 |
