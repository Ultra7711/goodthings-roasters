...
> **작성:** S179 (2026-05-07)
> **갱신:** S185 (2026-05-08) — BIZ INQUIRY Pilot 6 분리 (옵션 A: 3종 cross-route 잔류 — pageEnter / chp-shake 결합 / hover 차단 정책)
> **목적:** 9985 LOC 단일 globals.css 분할 작업의 진단 베이스 + Pilot 검증.

## 현황

- 단일 파일 라인 수: 9985 → 9796 (S179 Pilot 1) → 9715 (S180 Pilot 2) → 9596 (S181 OrderItemCard) → 9408 (S182 Pilot 3) → 9176 (S183 Pilot 4) → 8810 (S184 Pilot 5) → 8436 (S185 Pilot 6)
- 메이저 섹션 마커 (`/* ══...═ */`) 21개
...
6. **LOGIN** (409 LOC, line ~7200) — 라우트 단독, auth 영역 일반 검증
7. **MY PAGE** (647 LOC, line ~7610) — 라우트 단독, 다소 큼
