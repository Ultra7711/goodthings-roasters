...
> **작성:** S179 (2026-05-07)
> **갱신:** S181 (2026-05-07) — OrderItemCard 컴포넌트 추출 (.ocp-item* → .order-item* rename + colocate)
> **목적:** 9985 LOC 단일 globals.css 분할 작업의 진단 베이스 + Pilot 검증.

## 현황

- 단일 파일 라인 수: 9985 → 9796 (S179 Pilot 1) → 9715 (S180 Pilot 2) → 9596 (S181 OrderItemCard 추출)
- 메이저 섹션 마커 (`/* ══...═ */`) 21개
